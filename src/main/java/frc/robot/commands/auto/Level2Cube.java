...
public class Level2Cube extends ParallelRaceGroup {
	public Level2Cube(SwerveSubsystem s_swerve, ArmSubsystem s_arm, IntakeSubsystem s_intake, NeopixelDriver s_light,
			boolean zero) {
		setName("Level 2 Auto Cube");
		addCommands(
